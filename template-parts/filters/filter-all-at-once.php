...
<div class="all-at-once" data-taxonomy="<?= $taxonomy_slug; ?>" data-terms-ids="<?php echo implode(',', $array_of_active_terms_ids); ?>"  data-filter data-filter-operator="<?= $default_filtering_type; ?>">
